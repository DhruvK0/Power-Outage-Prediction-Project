...
![image](final_conf.png)

As we can see with our improved model, we have increased the amount of True Positives and True Negatives, while decreasing the False Positives by about 60% and decreasing the false negatives by 50%. This can be seen accordingly in our higher precision of 0.9 and increased recall of 0.85.
